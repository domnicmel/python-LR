...
def enterdate(a):
    ...
    while sw:
        ...
        if year > 0:
            ...
            print(askcorrectdate)
#..............................................................................................................            
#FUNCTION find  which is later date or if same dates
def sequencedate(a1,a2):
    [d1,m1,y1] = a1
    [d2,m2,y2] = a2
...
firstdateinput = "Enter first date:"           
seconddateinput = "Enter second date:"

firstdate = enterdate(firstdateinput)                   #CHECK FIRST DATE
seconddate = enterdate(seconddateinput)                 #CHECK 2ND DATE

[firstdate,seconddate] = sequencedate(firstdate,seconddate)     #SEQUENCE DATE IN ORDER
totaldaysbetween = daysinbetween(firstdate,seconddate)          #COUNT DAYS IN BETWEEN

print("Total days in between the two dates is", totaldaysbetween)
